...
//                .setOutputDir("/Users/xdclass/Desktop/demo/src/main/java") //这是绝对路径,可以存放在一个另外的目录下，然后再复制进项目
        ...
        dsConfig.setDbType(DbType.MYSQL)
                ...
                //TODO  TODO  TODO  TODO
                .setUrl("jdbc:mysql://39.108.182.26:3306/moshop_order?useSSL=false")
                .setUsername("root")
                .setPassword("mo12345");
        ...
        stConfig.setCapitalMode(true)
                ...
                //TODO  TODO  TODO  TODO
                .setInclude("mp_order", "mp_product_detail");
        ...
        //6. 执行操作
        ag.execute();
        System.out.println("======= MoShop-Order-Service Done 相关代码生成完毕  ========");
    }
}
